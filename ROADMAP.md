...
- [ ] Improve the empty state for first launch and no-open-document workflows.
...
- [ ] Add Markdown extensions that fit the lightweight goal: tables, task lists, strikethrough, footnotes, and heading anchors.
- [ ] Add code block syntax highlighting behind an optional feature or a small dependency.
